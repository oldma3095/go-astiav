...
```sh
export CGO_LDFLAGS="-L{{ path to your working directory }}/tmp/n8.0/lib/",
export CGO_CFLAGS="-I{{ path to your working directory }}/tmp/n8.0/include/",
export PKG_CONFIG_PATH="{{ path to your working directory }}/tmp/n8.0/lib/pkgconfig",
```
